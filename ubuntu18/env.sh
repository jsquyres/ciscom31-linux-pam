...
# Cisco version
export CISCO_VERSION=+1cisco4

# Info about the source
export UPSTREAM_VERSION=1.1.8
export UPSTREAM_DIR=$GITHUB_WORKSPACE/ubuntu18/pam-${UPSTREAM_VERSION}
export SOURCE_PACKAGE_VERSION=${UPSTREAM_VERSION}-3.6ubuntu2.18.04.3

# Name of the output directory and tarball
export OUTNAME=libpam0g-ubuntu18-with-4k-misc-buffer
